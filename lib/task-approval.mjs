...
import { getProjectTarget, createTaskFolder, resolveProjectRecords } from './project-targets.mjs';
...
export async function pollAllProjectApprovals() {
  ...
  for (const project of resolveProjectRecords(loadProjectRecords(), getWorkspaceRoots())) {
